...
static Key keys[] = {
    ...
    //{ShiftMask, XK_Print,
    // spawn,SHCMD("/home/dil/suckless/dwm/screenshotsel.sh")},
    {ShiftMask, XK_Print, spawn, SHCMD("/home/dil/suckless/dwm/maimsel.sh")},
    ...
    //{ MODKEY|ShiftMask,             XK_s,      spawn,           SHCHD("sudo
    // poweroff")},
    ...
    {0, XF86XK_AudioPlay, spawn,
     SHCMD("cmus-remote --server /run/user/1000/cmus-socket -p ")},
    {0, XF86XK_AudioNext, spawn,
     SHCMD("cmus-remote --server /run/user/1000/cmus-socket -n ")},
    {0, XF86XK_AudioPrev, spawn,
     SHCMD("cmus-remote --server /run/user/1000/cmus-socket -r ")},
    //	{ 0, XF86XK_AudioPause,         spawn, 	   SHCMD("cmus-remote --server
    /// run/user/1000/cmus-socket -u ")	 },
    {0, XF86XK_AudioStop, spawn,
     SHCMD("cmus-remote --server /run/user/1000/cmus-socket -u ")},
